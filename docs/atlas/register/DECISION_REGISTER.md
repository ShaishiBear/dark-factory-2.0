...
**419 decisions.** Extracted from the 7 September architecture corpus and the surrounding record, given stable IDs, statuses and tiers, with the 2026-09-08 evaluation folded in as explicit amendments rather than as a separate opinion.
...
DFE    29   Amendments from the 2026-09-08 evaluation and after
...
AMENDMENT         29     open, from the evaluation and after
...
tier 0   37      tier 1  177      tier 2  161      tier 3   44
```
...
## The twenty-nine open amendments
...
| **DFE-011** | Preflight self-optimisation loop — specify the mechanism for the four learned decisions | DFP-060/061/062/063, DFE-007, DFM-026 | Month-six; preconditions due now |
| **DFE-012** | Complete the ratchet family with a conditional cost ceiling | DFA-003, DFM-026, DFE-011 | Instrumentation is the work — see `10-ACP-003` |
| **DFE-013** | Unify the value-of-information rule and the search-worth test as one principle | DFP-018/060/061/062, DFE-005, DFE-012 | A paragraph; changes what gets built |
