...
- Cole's factory labels remain authoritative. Do not invent a second triage vocabulary.
...
When a Matt skill says to publish tickets, publish GitHub issues following these conventions. The factory remains responsible for deciding which issue enters `factory:accepted`.
