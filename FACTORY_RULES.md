...
- **Worker turns:** per-role caps in `factory_kernel/worker_policy.py` `ROLE_MAX_TURNS` (triage 20; plan 60; investigate 60; contract 30; context 80; architecture 30; test_author 60; implement 120; review-spec 40; review-standards 40; repair 80; conformance 30; holdouts and certifiers 10). Exceeding the cap fails the stage. Changing a cap is a trust-root change.
